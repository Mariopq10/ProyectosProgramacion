...
public class OperacionesDepart extends JDialog {
	...
	public OperacionesDepart() {
		...
		consultarDep(btnConsultar);
		
		//Accion boton modificar departamento
		modificarDep(btnModifcarDepartamento);
	}

	private void modificarDep(JButton btnModifcarDepartamento) {
	...
	private void consultarDep(JButton btnConsultar) {
	...
	private void borrarDep(JButton btnBorrarDepartamento) {
	...
	private void insertarDep(JButton btnInsertarDepartamento) {
